        ...
        <div class="carousel-wrapper">            
            ...
            <div class="slide">
                  <div class="textInfo-wrapper">
                    ...
                    <h1 class="heading title display">OCTOPOS</h1>
                    <p class="display subtitle">The smart Android countertop that eliminates charge to the merchant.</p>
                         <div class="image-wrapper">
                    <img src="<?= $base_url ?>/assets/images/products/OctopusDevice-Trans.webp" alt="" width="300px">
                </div>
  ...
  <style>
      ...
      /*Show desktop image only on desktop*/
        .slide{
          background:url(<?= $base_url ?>/assets/images/hero/desktopHero_OctoPOS_1.webp);
