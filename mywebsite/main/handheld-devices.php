...
$page_title = 'Handheld Payment Devices';
$products = getProductsByCategory($pdo, 'handheld');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section class="products-section">
        <div class="products-container">
            <div class="products-header">
                <h1>Handheld Payment Devices</h1>
                <p>Portable payment terminals and mobile card readers</p>
            </div>
