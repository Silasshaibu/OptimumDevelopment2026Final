        ...
        <div class="carousel-wrapper">
            <div class="slide">
                  <div class="textInfo-wrapper">
                    ...
                    <h1 class="heading title display">RECTANGLE</h1>
                    <p class="display subtitle">The smart Android countertop that eliminates charge to the merchant.</h1>
                         <div class="image-wrapper">
                    <img src="../assets/images/hero/clover-mini.webp" alt="" width="300px" fetchpriority="high">
                </div>
    ...
    <section class="noteDefault grid neutral">
      ...
      <div class="body-with-context flex">
        ...
        <div class="side image">
          <img
            src="../assets/images/products/clover-mini.webp"
            alt="product-image"
            width="100%"
