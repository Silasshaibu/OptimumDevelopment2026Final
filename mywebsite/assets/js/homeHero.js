   // Initialize all carousels except the Supplies carousel (handled by suppliesCategory.js) and Handheld carousel (handled by handheldProductsCategory.js)
   document.querySelectorAll("[data-carousel]").forEach(carouselEl => {
       if (!carouselEl.classList.contains('supplies') && !carouselEl.closest('.handheld')) {
