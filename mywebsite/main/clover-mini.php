        ...
        <div class="carousel-wrapper">            
            <div class="slide">
                  <div class="textInfo-wrapper">
                    ...
                    <h1 class="heading title display">CLOVER MINI</h1>
                    <p class="display subtitle">
                      Connect to best in class apps that help you run your business like Quickbooks for accounting , BigCommerce for ecommerce, and Homebase for staff scheduling.</p>
    ...
    <style>
      /*Show desktop image only on desktop*/
        @media(min-width:768px){
          .slide{
          background:url(<?= $base_url ?>/assets/images/hero/desktopHero_Clover-mini_1.webp);
    ...
    <section class="noteDefault grid neutral">
      <!-- 1- Full Blocks-->
      <div class="heading">
        <h2 class="content-title">Mini: a small but powerful POS system</h2>
      </div>
    ...
    <section class="noteDefault grid white">
      <div class="heading">
        <h2 class="content-title">Everything, at your fingertips</h2>
      </div>
      ...
      <div class="body-with-context flex">
        <div class="side text">
          ...
          <p class="textInfo">
            A small POS with real time 24/7 access to your data lets you check
            in and run your business from wherever you are.
          </p>
        </div>
      ...
      <div class="body-with-context flex">
        <div class="side text">
          ...
          <p class="textInfo">
            Mini works with all other Clover devices and can expand with
            accessories to build a complete system so your system can grow as
            your business grows.
          </p>
        </div>
