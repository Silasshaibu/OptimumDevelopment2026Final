...
$page_title = 'Shop (Affiliate Products)';
...
// Fetch all shop/affiliate products
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'shop' ORDER BY display_order ASC, created_at DESC");
$stmt->execute();
...
<div class="admin-card">
    <div class="admin-card-header">
        <h2>Shop (Affiliate Products)</h2>
        <div class="admin-actions">
            <a href="product_add.php?category=shop" class="btn btn-primary">
    ...
    <div class="admin-card-body">
        <?php if (empty($products)): ?>
            <div class="empty-state">
                <p>No products found. <a href="product_add.php?category=shop">Add your first product</a></p>
            </div>
        <?php else: ?>
